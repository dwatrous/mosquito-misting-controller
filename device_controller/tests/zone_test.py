...
if __name__ == '__main__':
  ...
  assert myzone.remove_sprayoccurrence({'daysofweek': [0, 6], 'timeofday': {'type': 'fixedtime', 'value': {'hour': 6, 'minutes': 0}}}) == {'daysofweek': [0, 6], 'timeofday': {'type': 'fixedtime', 'value': {'hour': 6, 'minutes': 0}}}
  assert len(myzone.sprayoccurrences) == len(default_sprayoccurrences)-1
  assert myzone.sprayoccurrences == [{'daysofweek': [0, 1, 2, 3, 4, 5, 6], 'timeofday': {'type': 'fixedtime', 'value': {'hour': 23, 'minutes': 0}}}, {'daysofweek': [1, 2, 3, 4, 5], 'timeofday': {'type': 'relativetime', 'value': {'sunevent': 'sunrise', 'sunposition': 'before', 'deltaminutes': 5}}}, {'daysofweek': [1, 2, 3, 4, 5], 'timeofday': {'type': 'relativetime', 'value': {'sunevent': 'dusk', 'sunposition': 'before', 'deltaminutes': 5}}}]
